...
//     std::fstream inOutCredit{"credit.txt", std::ios::in | std::ios::out | std::ios::binary};
...
//     std::cout << std::left << std::setw(10) << record.getAccountNumber() << std::setw(16) << record.getLastName() << std::setw(11)
//     << record.getFirstName()<< std::setw(10) << std::setprecision(2) << std::right << std::fixed << std::showpoint << record.getBalance() << std::endl;
// }
